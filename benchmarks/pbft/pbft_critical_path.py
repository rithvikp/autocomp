...
class DedalusPBFTCriticalPathOutput(NamedTuple):
    read_output: benchmark.RecorderOutput
    write_output: benchmark.RecorderOutput


Output = DedalusPBFTCriticalPathOutput


# Networks #####################################################################
class DedalusPBFTCriticalPathNet:
...
# Suite ########################################################################
class DedalusPBFTCriticalPathSuite(benchmark.Suite[Input, Output]):
    def run_benchmark(self,
                      bench: benchmark.BenchmarkDirectory,
                      args: Dict[Any, Any],
                      input: Input) -> Output:
        net = DedalusPBFTCriticalPathNet(input, self.provisioner.hosts(input.f))
        ...
        return DedalusPBFTCriticalPathOutput(read_output = read_output,
